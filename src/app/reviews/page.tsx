...
function RatingDistribution({ stats }: RatingDistributionProps) {
  ...
  return (
    <div className="space-y-2">
      <h4 className="text-sm font-medium text-rupeebee-dark-text mb-3">Rating Breakdown</h4>
        ...
        return (
          <div key={rating} className="flex items-center gap-3">
            <div className="flex items-center gap-1 min-w-[50px]">
              <span className="text-sm font-medium text-rupeebee-dark-text w-2 text-center">{rating}</span>
              <Star className="w-4 h-4 fill-yellow-400 text-yellow-400 flex-shrink-0" />
            </div>
            
            <div className="flex-1 bg-gray-100 rounded-full h-2.5 relative overflow-hidden">
              <div 
                className={`bg-gradient-to-r from-yellow-400 to-yellow-500 h-2.5 rounded-full transition-all duration-500 ease-out ${getWidthClass(percentage)}`}
              />
            </div>
            
            <span className="text-xs text-rupeebee-medium-text min-w-[35px] text-right">
              {count > 0 ? `${count}` : '0'}
            </span>
          </div>
        );
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
            ...
            >
              <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 sticky top-8 h-fit">
                <h3 className="text-xl font-bold text-rupeebee-dark-text mb-6 text-center">
                  Overall Rating
                </h3>
                
                <div className="text-center mb-6">
                  <div className="text-5xl font-bold text-rupeebee-dark-text mb-3">
                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  <div className="bg-gradient-to-br from-rupeebee-light-green/10 to-rupeebee-medium-green/10 rounded-xl p-4 border border-rupeebee-light-green/20">
                    <div className="mb-3">
                      <h4 className="font-semibold text-rupeebee-dark-text text-sm mb-1">Share Your Story</h4>
                      <p className="text-xs text-rupeebee-medium-text">Help others discover RupeeBee</p>
                    </div>
                    
                    <Link href="/reviews/write">
                      <Button className="w-full bg-gradient-to-r from-rupeebee-medium-green to-rupeebee-dark-green hover:from-rupeebee-dark-green hover:to-rupeebee-medium-green text-white py-2.5 font-medium transition-all duration-300 shadow-sm hover:shadow-md text-sm">
              ...
              <div className="space-y-4">
                {reviews.map((review, index) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        <div className="w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
                          ...
                          <div className={`w-full h-full bg-rupeebee-medium-green rounded-full flex items-center justify-center ${review.user_avatar ? 'hidden' : 'flex'}`}>
                        ...
                        <div className="min-w-0 flex-1">
                          <div className="flex flex-col gap-1 mb-2">
                            <div className="flex items-center gap-2">
                              <span className="font-semibold text-rupeebee-dark-text truncate">
                              ...
                              {review.rupeebee_user_id && (
                                <span className="text-xs bg-rupeebee-light-green text-rupeebee-dark-green px-2 py-1 rounded-full font-medium">
                                  App User
                                </span>
                              )}
                            </div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-rupeebee-medium-text flex-shrink-0 ml-4">
                    ...
                    <p className="text-rupeebee-dark-text leading-relaxed mb-4 break-words">
                      {review.review_text}
                    </p>
